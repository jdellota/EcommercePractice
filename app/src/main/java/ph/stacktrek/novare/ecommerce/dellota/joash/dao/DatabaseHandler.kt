package ph.stacktrek.novare.ecommerce.dellota.joash.dao
...
class DatabaseHandler(context: Context):
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("Insert into $TABLE_PRODUCT ($TABLE_PRODUCT_NAME) values ('Water')")
        db?.execSQL("Insert into $TABLE_PRODUCT ($TABLE_PRODUCT_NAME) values ('Ice')")
        db?.execSQL("Insert into $TABLE_PRODUCT ($TABLE_PRODUCT_NAME) values ('Coke')")
    }
